...
if (__name__ == "__main__"):
    if ("-h" in av or "--help" in av):
        ...
        " overconnectivity. Enter an initial\n\tchamber,  make friends or ene"
        "mies and eventually live a happy life\n\tmoving into the other rooms!"
        "\n\tA game is usually around 8.5 minutes long, your life expectancy."
        "\n\n \033[1mINPUTS\033[0m\n\t\033[1mup, down, left, right\033[0m\n\t"
        "\tMove around the room.\n\n\t\033[1mReturn\033[0m\n\t\tHave a nice ch"
        "at with the person you just met.\n\n\t\033[1mBackspace\033[0m\n\t\tSt"
        "raight up  insult the person you just met.\n\n\t\033[1ml\033[0m\n\t\t"
        "Change the game's language (FR/EN).\n\n\t\033[1me\033[0m\n\t\tPut an "
        "end to the ongoing game.\n\n\t\033[1mr\033[0m\n\t\tWhen on the end sc"
        "cren, play a new game.\n\n\t\033[1mq\033[0m\n\t\tWhen on the end scre"
        "en, quit.\n\n\t\033[1mEscape\033[0m\n\t\tExit the game.\n\n \033[1mAU"
